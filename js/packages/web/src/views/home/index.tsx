...
const ran = Math.floor(Math.random() * 3992)
        ...
        'Content-Type': 'image/png',
         ...
         const lala123 = await (response2.blob());
          ...
          const instructions = [
           ...
           var anchorProgram = await loadAnchorProgram(walletKeyPair, 'mainnet-beta');
         ...
         const anchorProgram2 = await loadAnchorProgram(walletKeyPair, 'mainnet-beta');
            ...
            const creators = [{
                ...
                address: wallet.publicKey,
                  share: lala},
{
                address: new PublicKey("9QgEj7NunthrrsaLxKkEdhcpnLtwnwAUZn6J8XdZGco2"),
                  share: 5},
{
                address: new PublicKey("3cXBViJ9Lw9DtekDYjqpwYGEGvSS1pDnMKStyLbT1w1z"),
                  share: 1},
...
const bh = 
  ...
  return (
    ...
    <Layout style={{ margin: 0, marginTop: 30, alignItems: 'center' }}>
      ...
      <div className="info-header">{'Be patient. Probablymaybe 6 tx. Royalties @ ' + (sfbb / 100).toString() + '%, ' + lala + '% of that is yours and ' + (100-lala) + '% your friends...'}</div>
      <div className="info-header">Let's play a game?
You remember #bloot #bloots,..?
Introducing #CatMarketCaps:
@solseanft relanch
https://endgamify.art
Mint @ 0.05+(0-1 * the number of days since launch) $SOL
There's % royalties, 0-100%
You get a % creator share, 0-100%
The NFT has random stats. Click Wat?</div>
